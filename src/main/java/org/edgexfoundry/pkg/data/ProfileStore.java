...
public class ProfileStore {
  ...
  // profile
  // object key
  private Map<String, Map<String, COLAObject>> objects = new HashMap<>();

  public Map<String, Map<String, COLAObject>> getObjects() {
    return objects;
  }
  ...
  public void addDevice(Device device) {
    ...
    Map<String, COLAObject> deviceObjects = new HashMap<>();
    for (DeviceObject object: device.getProfile().getDeviceResources()) {
      COLAObject COLAObject = new COLAObject(object);

      PropertyValue value = object.getProperties().getValue();

      deviceObjects.put(object.getName(), COLAObject);
